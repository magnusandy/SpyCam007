//RUN go run sample.go --project=laforgesplayground --bucket=laforgesplayground.appspot.com --file=me.jpg
//this will upload the file to the cloud server, which you can see
//the mediaLink is the embeddable link we can use for website or soemthing
